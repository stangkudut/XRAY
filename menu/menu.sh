...
echo -e "${BB}╚═══════════════════════════════════════════════════════╝${NC}"
echo -e "${CB}Public IP${NC}        ${WB}: $MYIP          "
echo -e "${CB}Service Provider${NC} ${WB}: $ISP           "
echo -e "${CB}Timezone${NC}         ${WB}: $WKT${NC}      "
echo -e "${CB}City${NC}             ${WB}: $CITY${NC}     "
echo -e "${CB}Date${NC}             ${WB}: $DATE${NC}     "
